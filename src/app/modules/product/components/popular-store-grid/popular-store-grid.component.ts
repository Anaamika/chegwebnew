...
@Component({
  selector: 'app-popular-store-grid',
  templateUrl: './popular-store-grid.component.html',
  styleUrls: ['./popular-store-grid.component.scss']
})
export class PopularStoreGridComponent implements OnInit {
